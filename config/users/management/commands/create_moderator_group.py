...
class Command(BaseCommand):
    """
    Команда для создания группы модераторов в системе.

    Эта команда создает группу модераторов, назначает ей права
    ...
    def handle(self, *args, **kwargs):
        ...
        Создает группу модераторов, назначает ей необходимые права и
        добавляет список пользователей в эту группу.
